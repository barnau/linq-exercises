...
namespace LinqExercises.Controllers
{
    public class SuppliersController : ApiController
    {
        ...
        public IHttpActionResult GetSalesAndMarketing()
        {
            ...
            var result = _db.Suppliers.Where(s => s.ContactTitle == "Marketing Manager" || s.ContactTitle == "Sales Representatives" && s.Fax != null);
        ...
        {
            var result = _db.Suppliers.Where(s => s.Address.Contains(term));
            return Ok(result);
